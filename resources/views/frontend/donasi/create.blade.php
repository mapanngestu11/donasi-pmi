                        ...
                        <div class="card-body p-5">
                            ...
                            <form action="{{ route('donasi.store') }}" method="POST" id="donasiForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jumlah_select">
                                        <option value="">-- Pilih Jumlah Donasi --</option>
                                        <option value="10000">Rp 10.000</option>
                                        <option value="20000">Rp 20.000</option>
                                        <option value="50000">Rp 50.000</option>
                                        <option value="100000">Rp 100.000</option>
                                        <option value="other">Nominal Lainnya</option>
                                    </select>
                                    ...
                                    {{-- Input manual --}}
                                    <input type="text" id="jumlah_manual" class="form-control mt-2 d-none"
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        const select = document.getElementById("jumlah_select");
                                        const manualInput = document.getElementById("jumlah_manual");
                                        ...
                                        manualInput.addEventListener("input", function() {
                                            ...
                                            this.value = formatRupiah(angkaBersih);
                                            hiddenInput.value = angkaBersih; // yang dikirim angka asli
                                        });
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('pesan') is-invalid @enderror" id="pesan" name="pesan" rows="3"
