...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="hero-content">
                        ...
                        <p class="wow fadeInLeft" data-wow-delay=".6s">Bersama Palang Merah Indonesia, mari wujudkan
                            kepedulian kita untuk membantu sesama yang membutuhkan melalui donasi online yang mudah dan
                            terpercaya.</p>
                        <div class="button wow fadeInLeft" data-wow-delay=".8s">
                            <a href="{{ route('donasi.create') }}" class="btn"><i class="lni lni-heart"></i> Donasi
                                Sekarang</a>
                            <a href="#about" class="btn btn-alt"><i class="lni lni-information"></i> Pelajari Lebih
                                Lanjut</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h3 class="wow zoomIn" data-wow-delay=".2s">Donatur</h3>
                        <h2 class="wow fadeInUp" data-wow-delay=".4s">Donatur Terbaru</h2>
                        <p class="wow fadeInUp" data-wow-delay=".6s">Terima kasih kepada para Donatur yang telah
                            berpartisipasi dalam program kemanusiaan PMI.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="pendonasi-card-body">
                                ...
                                @if ($pesan != '')
                                    <div class="pendonasi-message">
                                        ...
                                        <p style="color: #000 !important; font-weight: 500 !important; margin: 0;">
                                            {{ $pesan }}</p>
                                    </div>
                                @endif
                            ...
                            <div class="single-berita wow fadeInUp" data-wow-delay=".{{ $loop->iteration * 2 }}s">
                                <div class="berita-image">
                                    <img src="{{ $berita->gambar_url }}" alt="{{ $berita->judul }}"
                                        onerror="this.src='{{ asset('assets/images/hero/phone.png') }}'">
                                    @if ($berita->kategori)
                                ...
                                <div class="berita-content">
                                    ...
                                    <h4 class="berita-title">
                                        <a
                                            href="{{ route('frontend.berita.detail', $berita->slug) }}">{{ $berita->judul }}</a>
                                    </h4>
                                    <p class="berita-excerpt">
                                        {{ Str::limit($berita->ringkasan ? $berita->ringkasan : strip_tags($berita->konten), 120) }}
                                    </p>
                                    <a href="{{ route('frontend.berita.detail', $berita->slug) }}" class="berita-link">Baca
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="single-gallery wow fadeInUp" data-wow-delay=".{{ $loop->iteration * 2 }}s">
                            <div class="gallery-image">
                                @if ($gallery->gambar)
                                    <a href="javascript:void(0)" class="gallery-modal-trigger"
                                ...
                                @else
                                    <img src="{{ asset('assets/images/hero/phone.png') }}"
                                        alt="{{ $gallery->judul_kegiatan }}">
                                @endif
                                <div class="gallery-overlay">
                                    <div class="gallery-content">
                                        ...
                                        @endif
                                        @if ($gallery->tanggal)
                                            <span class="gallery-date"><i class="lni lni-calendar"></i>
                                                {{ $gallery->tanggal->format('d M Y') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
    ...
    <section id="about" class="section call-action"
        style="background: linear-gradient(135deg, #DC143C 0%, #B71C1C 100%); padding: 80px 0;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center mb-5">
                        <h2 class="wow fadeInUp" data-wow-delay=".2s"
                            style="color: #fff; font-size: 36px; font-weight: 700; margin-bottom: 15px;">Laporan Keuangan
                        </h2>
                        <p class="wow fadeInUp" data-wow-delay=".4s"
                            style="color: rgba(255,255,255,0.9); font-size: 16px; margin: 0;">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <ul class="nav nav-tabs card-header-tabs" id="financialTabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="pemasukan-tab" data-toggle="tab"
                                            href="#pemasukan" role="tab" aria-controls="pemasukan"
                                            aria-selected="true">
                                ...
                                <div class="download-buttons">
                                    <button type="button" class="btn btn-download btn-excel" onclick="exportToExcel()"
                                        title="Download Excel">
                                        <i class="fas fa-file-excel"></i> Excel
                                    </button>
                                    <button type="button" class="btn btn-download btn-pdf" onclick="exportToPDF()"
                                        title="Download PDF">
                        ...
                        <div class="card-body financial-body">
                            <div class="tab-content" id="financialTabsContent">
                                            ...
                                            @if (isset($pemasukan) && $pemasukan->count() > 0)
                                                <tfoot>
                                                    <tr class="subtotal-row">
                                                        <td colspan="2" class="text-right font-weight-bold">Sub Total:
                                                        </td>
                                ...
                                <div class="tab-pane fade" id="pengeluaran" role="tabpanel"
                                    aria-labelledby="pengeluaran-tab" style="display: none;">
                                    <div class="table-responsive">
                                        <table class="table financial-table">
                                            <thead>
                                                <tr>
                ...
                function initGalleryModal() {
                    ...
                    galleryTriggers.forEach(function(trigger) {
                        trigger.addEventListener('click', function(e) {
                            ...
                            if (modalDate) modalDate.innerHTML = '<i class="lni lni-calendar"></i> ' + (
                                date || '');
