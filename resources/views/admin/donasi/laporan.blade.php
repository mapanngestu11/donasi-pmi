...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0" style="color: #fff !important;">Laporan Donasi</h1>
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}" style="color: rgba(255,255,255,0.8) !important;">Home</a></li>
    <li class="breadcrumb-item" style="color: rgba(255,255,255,0.8) !important;">Donasi</li>
    <li class="breadcrumb-item active" aria-current="page" style="color: #fff !important;">Laporan Donasi</li>
  </ol>
</div>
    ...
    <div class="card mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color: #f8f9fc !important; border-bottom: 1px solid #e3e6f0;">
        ...
        <div class="d-flex align-items-center" style="gap: 10px;">
          <select id="filterStatus" class="form-control form-control-sm" style="max-width: 180px; font-size: 14px;">
            <option value="">Semua Status</option>
            <option value="pending">Pending</option>
            <option value="settlement">Sudah Pembayaran</option>
          </select>
          <a href="{{ route('admin.donasi.laporan.export') }}" class="btn btn-success btn-sm" id="btnExport" title="Export Excel">
  ...
  $(document).ready(function() {
    table = $('#dataTableHover').DataTable({
      ...
      columns: [
        ...
        { data: 'keterangan_pesan', name: 'keterangan_pesan' },
        { data: 'bank', name: 'bank' },
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.success) {
          ...
          $('#detail-status').html('<span class="badge badge-' + getStatusBadge(data.status) + '">' + data.status.toUpperCase() + '</span>');
